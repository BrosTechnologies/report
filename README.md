...
|  |    Mario Prado Vargas               |   U202115357        | Ingeniería de Software | Frontend: Angular, Tailwind . Backend: Desarrollo de APIs REST con Spring Boot y .NET. Conocimientos adicionales: C++, gestión de bases de datos, java, python, javascript. También cuento con base en HTML, CSS y el framework Tailwind v4.0. Actualmente estoy aprendiendo desarrollo de redes neuronales y machine learning. |
